...
app.get('/getinvitedeventlist/:name', function (req, res) {
  ...
  db.eventlist.find({"schoolName":req.params.name},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.post('/eventnotification/:name/:id/:username', function (req, res) {
  ...
  db.eventnotificationlist.insert({"schoolName":req.params.name, "eventId":req.params.id, "schoolUsername":req.params.username }, function(err, doc) {
    res.json(doc);
  });
});
...
app.get('/geteventnotification/:name', function (req, res) {
  ...
  db.eventnotificationlist.find({"schoolName":req.params.name},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.get('/geteventlistnoti/:id', function (req, res) {
  ...
  db.eventlist.findOne({_id: mongojs.ObjectId(req.params.id)},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.delete('/deleteeventnotification/:id/:name', function (req, res) {
  ...
  db.eventnotificationlist.remove({"eventId": id, "schoolName": req.params.name}, function (err, doc) {
    res.json(doc);
  });
});
...
app.post('/parentnotification/:id/:name/:email', function (req, res) {
  ...
  db.parentnotification.insert({"schoolName":req.params.name, "eventId":req.params.id, "ParentEmail":req.params.email }, function(err, doc) {
    res.json(doc);
  });
});
...
app.get('/getteamnumber/:name', function (req, res) {
  ...
  db.eventlist.findOne({eventName: req.params.name},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.get('/parentauth/:name/:password', function (req, res) {
  ...
  db.studentlist.find({},{"parentEmail":1,"parentContactnumber":1,_id:0}).toArray(function (err, docs) {
	console.log(docs);
	//console.log(docs[0].username);
	flag = "unsuccessful";
...
app.get('/parentprofile/:email', function (req, res) {
  ...
  db.studentlist.findOne({"parentEmail":req.params.email},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.get('/checkparentIdintoNoti/:email', function (req, res) {
  ...
  db.parentnotification.find({"ParentEmail":req.params.email},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.delete('/deleteparenteventnotification/:id/:name', function (req, res) {
  ...
  db.parentnotification.remove({"eventId":id, "ParentEmail": req.params.name}, function (err, doc) {
    res.json(doc);
  });
});
...
app.get('/findjudgelist/:email', function (req, res) {
  ...
  db.judgelist.find({"parentEmail":req.params.email},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.put('/judgelist/:email/:id', function (req, res) {
  ...
  db.judgelist.findAndModify({
    query: {eventId: req.params.id , parentEmail: req.params.email},
    update: {$set: {reached: "yes"}},
    new: true}, function (err, doc) {
      res.json(doc);
    }
  );
...
app.get('/getjudgelist/:id', function (req, res) {
  ...
  db.judgelist.find({eventId: req.params.id},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.post('/insertteamlist/:id/:username/:parentname/:teamnum', function (req, res) {
  ...
  db.teamlist.insert({"schoolName":req.params.username, "eventId":req.params.id, "parentName":req.params.parentname, "teamNumber":req.params.teamnum }, function(err, doc) {
    res.json(doc);
  });
});
...
app.get('/getteamlist/:id/:name', function (req, res) {
  ...
  db.teamlist.find({"eventId": req.params.id, "schoolName": req.params.name},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
console.log("update : " + req.params.id + " " + req.params.parent);
  ...
  db.judgelist.findAndModify({
    query: {eventId: req.params.id , parentEmail: req.params.parent},
    update: {$set: {assign: "yes"}},
    new: true}, function (err, doc) {
		console.log(doc);
		res.json(doc);
    }
...
app.get('/getparentmail/:name', function (req, res) {
  ...
  db.studentlist.findOne({"parentName":req.params.name},(function (err, docs) {
	console.log(docs);
	res.send(docs);
...
app.put('/updateteamlistassignDrop/:id/:team/:name', function (req, res) {
  ...
  db.teamlist.findAndModify({
    query: {eventId: req.params.id , teamNumber: req.params.team},
    update: {$set: {parentName: req.params.name}},
    new: true}, function (err, doc) {
		console.log(doc);
		res.json(doc);
    }
...
app.put('/updatjudgelistDrop/:id/:mail', function (req, res) {
  ...
  db.judgelist.findAndModify({
    query: {eventId: req.params.id , parentEmail: req.params.mail},
    update: {$set: {assign:"yes"}},
    new: true}, function (err, doc) {
		console.log(doc);
		res.json(doc);
